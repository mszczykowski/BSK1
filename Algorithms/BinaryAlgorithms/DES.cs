...
namespace BSK1.Algorithms.BinaryAlgorithms
{
    internal class DES : Algorithm
    {
        ...
        // 64 bits
        private int[] InitialPermutation { get; } =
        ...
        // 64 bits -> 56 bits
        private int[] PermutedChoice1 { get; } =
            { 57, 49, 41, 33, 25, 17, 9,
              1, 58, 50, 42, 34, 26, 18,
              10, 2, 59, 51, 43, 35, 27,
              19, 11, 3, 60, 52, 44, 36,
        ...
        private int[] ShiftArray { get; } = { 1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1 };

        // 56 bits -> 48 bits
        private int[] PermutedChoice2 { get; } =
            { 14, 17, 11, 24, 1, 5,
              3, 28, 15, 6, 21, 10,
              23, 19, 12, 4, 26, 8,
              16, 7, 27, 20, 13, 2,
        ...
        // 32 bits -> 48 bits
        private int[] ExtensionArray { get; } =
            { 32, 1, 2, 3, 4, 5,
              4, 5, 6, 7, 8, 9,
              8, 9, 10, 11, 12, 13,
              12, 13, 14, 15, 16, 17,
        ...
        // 64 bits
        private int[] InitialPermutationInverted { get; } = 
